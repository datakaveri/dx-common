...
public class RoutingContextHelper {
  ...
  /**
   * Store an arbitrary metadata value on the routing context under a named key.
   * Useful for passing domain objects (e.g. Asset) between handlers without
   * coupling to specific typed accessors.
   */
